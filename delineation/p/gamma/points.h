...
std::vector<Point> points_processing(const ECGLead& ecg_lead, WaveDelineation& delineation, PMorphologyData& morphology_data) {
...
std::vector<Point> points_processing_trivial(const ECGLead& ecg_lead, WaveDelineation& delineation) {
