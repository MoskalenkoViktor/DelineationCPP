    ...
    int s_zc_id_diff, const std::vector<Point>& right_points)
{
    ...
    QRSMorphologyData qrs_morph_data2(ecg_lead, *delineation, scale_id);

    r_zc_id = qrs_morph_data2.peak_zcs_ids[scale_id];
    q_zc_id = r_zc_id + q_zc_id_diff;
    s_zc_id = r_zc_id + s_zc_id_diff;
    ...
    offset_processing(s_zc_id, ecg_lead, delineation, qrs_morph_data2, &points, 1);
    ...
    int s_zc_id_diff, const std::vector<Point>& right_points)
{
    ...
    onset_processing(q_zc_id, ecg_lead, delineation, qrs_morph_data2, &points, -1);
