...
//    size_t searching_onset_left_border_index = 0;
//
...
//    double onset_mm_candidate_coeff = abs(current_mm.value) * float(ONSET_MM_COEFF);
//
...
//    double threshold = mm_list[correct_onset_mm_id].value * float(ONSET_OFFSET_THRESHOLD);
//
