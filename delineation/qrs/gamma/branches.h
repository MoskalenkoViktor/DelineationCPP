    ...
    const QRSMorphologyData& qrs_morphology_data, int q_zc_id_diff, int s_zc_id_diff)
{
    ...
    int64_t r_zc_id_index = static_cast<int>(std::distance(dels_zcs_ids.begin(), it));
    int64_t q_zc_id_index = r_zc_id_index + q_zc_id_diff;
    int64_t s_zc_id_index = r_zc_id_index + s_zc_id_diff;
    ...
    int64_t real_r_zc_id_index = static_cast<int>(std::distance(real_dels_zcs_ids.cbegin(), it));
    int64_t real_q_zc_id_index = real_r_zc_id_index - 1;
    int64_t real_s_zc_id_index = real_r_zc_id_index + 1;
    ...
    const QRSMorphologyData& qrs_morphology_data, int q_zc_id_diff, int s_zc_id_diff)
{
    ...
    int64_t r_zc_id = peak_zc_id;
    int64_t q_zc_id = r_zc_id + q_zc_id_diff;
    int64_t s_zc_id = r_zc_id + s_zc_id_diff;
    ...
    int r_zc_id_index = static_cast<int>(std::distance(dels_zcs_ids.begin(), it));
    ...
    it = std::find(real_dels_zcs_ids.begin(), real_dels_zcs_ids.end(), r_zc_id);
    int real_r_zc_id_index = static_cast<int>(std::distance(real_dels_zcs_ids.cbegin(), it));
